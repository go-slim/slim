...
type Extractor func(context slim.Context) (string, error)
...
RateLimiter returns a rate limiting middleware
	...
	s.GET("/rate-limited", func(c slim.Context) error {
		return c.String(http.StatusOK, "test")
	}, RateLimiter(limiterStore))
*/
func RateLimiter(store RateLimiterStore) slim.MiddlewareFunc {
...
RateLimiterWithConfig returns a rate limiting middleware
	...
	config := middleware.RateLimiterConfig{
		...
		DenyHandler: func(context slim.Context, identifier string) error {
...
*/
func RateLimiterWithConfig(config RateLimiterConfig) slim.MiddlewareFunc {
